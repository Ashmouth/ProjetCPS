...
public class CharacterBug implements CharacterService {
	protected int life;
	protected int speed;
	...
	public void init(int l, int s, boolean f, EngineService e) {
		...
		HitboxRectService hr = new HitboxRectBug();
		hr.init(0,0,90,150);
	...
	public void moveLeft() {
		int x, y;
		//HACK
		y = hitbox.getPositionX();
		x = hitbox.getPositionY();
	...
	public void crouch() {
		...
		if(hitbox instanceof HitboxRectBug) {
			HitboxRectBug hb = (HitboxRectBug)hitbox;
